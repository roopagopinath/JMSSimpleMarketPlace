...
public class MarketPlace {
	...
	//Method to Sign-up
	public boolean signUp(String firstName, String lastName, String emailID, String password, String userID)
	{
		try{
	...
	public boolean signOut(String userID){
		try{
			...
			boolean outStatus = insStatement.execute();
			return !outStatus;
	...
	public boolean storeAdvertisement(String itemName, String itemDesc, float price, int quantity, String userID){
		try{
			...
			boolean stat = insStatement.execute();
			System.out.println("The execute statement returned " + stat);
	...
	public String[] displayAdvertisement(String buyerID){
		try{
			...
			PreparedStatement selStatement = con.prepareStatement("select * from tbl_advertisement where quantity > 0 and userID != ?");
